...
<div class="max-w-2xl mx-auto bg-white p-6 rounded-md shadow">
    <h2 class="text-xl font-semibold mb-4 text-gray-800">Tambah Suplier</h2>

    <form action="{{ route('admin.supliers.store') }}" method="POST" class="space-y-4">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="email" name="email" id="email" value="{{ old('email') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-500">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <label><input type="radio" name="jenis_kelamin" value="L" class="mr-1" {{ old('jenis_kelamin')=='L'?'checked':'' }}> Laki-laki</label>
                    <label><input type="radio" name="jenis_kelamin" value="P" class="mr-1" {{ old('jenis_kelamin')=='P'?'checked':'' }}> Perempuan</label>
                </div>
            ...
            <div>
                ...
                <input type="text" name="nama_pt" id="nama_pt" value="{{ old('nama_pt') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-500">
            ...
            <div>
                ...
                <input type="text" name="brand" id="brand" value="{{ old('brand') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-500">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <label><input type="radio" name="tipe_bank" value="Bank" class="mr-1" onchange="toggleBank()" {{ old('tipe_bank')=='Bank'?'checked':'' }}> Bank</label>
                    <label><input type="radio" name="tipe_bank" value="E-Wallet" class="mr-1" onchange="toggleBank()" {{ old('tipe_bank')=='E-Wallet'?'checked':'' }}> E-Wallet</label>
                </div>
                @error('tipe_bank')<p class="text-sm text-red-500 mt-1">{{ $message }}</p>@enderror
            </div>
            <div class="md:col-span-2" id="bankList" class="hidden">
            ...
            <div class="md:col-span-2" id="ewalletList" class="hidden">
            ...
            <div>
                ...
                <input type="text" name="no_rekening" id="no_rekening" value="{{ old('no_rekening') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-500">
            ...
            <div>
                ...
                <input type="text" name="atas_nama" id="atas_nama" value="{{ old('atas_nama') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-500">
